        ...
        <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-5xl">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-base font-bold text-white tracking-tight hidden md:inline-block">XYTO Hosting</span>
            </div>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-base font-bold text-white tracking-tight">XYTO Hosting</span>
              </div>
